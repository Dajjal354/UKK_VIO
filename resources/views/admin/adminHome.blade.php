...
<!-- Page Heading -->
<div class="d-sm-flex align-items-center justify-content-between mb-4 p-3 bg-light rounded shadow">
    <h1 class="h3 text-dark font-weight-bold mb-0">Dashboard</h1>
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                            PT Alumni</div>
                        <div class="h4 mb-0 font-weight-bold text-gray-800">120</div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                            Firma Alumni</div>
                        <div class="h4 mb-0 font-weight-bold text-gray-800">45</div>
                    </div>
                    <div class="col-auto">
